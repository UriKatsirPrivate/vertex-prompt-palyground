...
REGIONS=["global"]
MODEL_NAMES=['gemini-3.1-flash-lite-preview','gemini-3-flash-preview','gemini-3.1-pro-preview']
...
def generate_llm_content(_client, project_id, region, model_name, contents, _generation_config, system_instruction=None):
    ...
    try:
        ...
        return "" # Return empty string on error, or a dummy response object if needed by callers
...
def create_refine_prompt(_client, project_id, region, model_name, _generation_config, user_input):
    ...
    return generate_llm_content(_client, project_id, region, model_name, prompt, _generation_config).text
...
def create_meta_prompt(_client, project_id, region, model_name, _generation_config, user_input):
    return generate_llm_content(_client, project_id, region, model_name, user_input, _generation_config).text
...
def json_prompter(_client, project_id, region, model_name, _generation_config, user_input):
    ...
    response = generate_llm_content(_client, project_id, region, model_name, prompt, _generation_config)
    return response
...
def zero_to_few_prompt(_client, project_id, region, model_name, _generation_config, user_input):
    ...
    return generate_llm_content(_client, project_id, region, model_name, prompt, _generation_config, system_instruction=system_prompt).text
...
def dare_it(_client, project_id, region, model_name, _generation_config, query, vision, mission, context):
    ...
    return generate_llm_content(_client, project_id, region, model_name, formatted_prompt, _generation_config).text
...
def create_dare_artifacts(_client, project_id, region, model_name, temperature, top_p, max_tokens, _safety_settings, user_input):
    ...
    return generate_llm_content(_client, project_id, region, model_name, formatted_prompt, config, system_instruction=system_prompt).text
